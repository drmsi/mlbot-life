...
(() => {
  ...
  // ── Config ──────────────────────────────────────────────────────────
  const BRIDGE_URL  = 'https://mlbot.ddd.bz/strat4';   // [strat4 dashboard fork] — points at /strat4 path-prefix on the same host; nginx strips the prefix and forwards to the strat4 bridge on port 5558 (F6 demo, XAUUSD only)
