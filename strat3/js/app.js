...
(() => {
  ...
  // ── Config ──────────────────────────────────────────────────────────
  const BRIDGE_URL  = 'https://mlbot.ddd.bz/strat3';   // [strat3 dashboard fork] — points at /strat3 path-prefix on the same host; nginx strips the prefix and forwards to the strat3 bridge on port 5557
